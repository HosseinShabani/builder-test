    ...
    <div className="w-full min-h-screen bg-slate-800 text-slate-400">
      <main className="py-10 px-4 sm:p-6 md:py-16 md:px-8">
        <div className="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
          <ul className="grid gap-4 col-start-1 col-end-3 row-start-1 sm:mb-6 sm:grid-cols-4 lg:gap-6 lg:col-start-2 lg:row-end-6 lg:row-span-6 lg:mb-0">
            <li className="w-full h-60 object-cover rounded-lg sm:h-52 sm:col-span-2 lg:col-span-full">
              <p className="text-sm  leading-1 lg:leading-4 font-medium text-white sm:text-slate-500 dark:sm:text-slate-400">
                Entire house
              </p>
              <img
                className="h-[95%] lg:h-full object-fit w-full"
                src={beachHouse}
                alt=""
                loading="lazy"
              />
            </li>
            <li className="hidden w-full h-52 object-cover rounded-lg sm:block sm:col-span-2 md:col-span-1 lg:row-start-2 lg:col-span-2 lg:h-32">
            ...
            <li className="hidden w-full h-52 object-cover rounded-lg md:block lg:row-start-2 lg:col-span-2 lg:h-32">
              <p className="text-sm leading-4 font-medium text-white sm:text-slate-500 dark:sm:text-slate-400">
                Entire house
              </p>
              <img
          ...
          <img
            className="block object-fit  h-auto w-full grid gap-4 col-start-1 col-end-3 row-start-3 sm:mb-6 sm:grid-cols-4 lg:gap-6 lg:col-start-2 lg:row-end-6 lg:row-span-6 lg:mb-0"
            src={beachHouseInterior1}
            alt=""
            loading="lazy"
          />
          <svg
            ...
            aria-hidden="true"
            fill="currentColor"
            className="mx-3 text-slate-300 row-start-4 my-2"
          >
            <circle cx="1" cy="1" r="1" />
          </svg>
